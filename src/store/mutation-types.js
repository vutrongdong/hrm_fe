...
export const SET_TABLE_DATAS = 'TABLE/SET_TABLE_DATAS'
export const SET_TABLE_PAGINATION = 'TABLE/SET_TABLE_PAGINATION'
export const SET_TABLE_PAGINATIONS = 'TABLE/SET_TABLE_PAGINATIONS'
export const SET_TABLE_QUERIES = 'TABLE/SET_TABLE_QUERIES'
